      ...
      <div className="container">
        <div className="hero-panel">
          <div className="hero-copy">
            <p className="eyebrow">Smart inventory control</p>
            <h2>Run your stock with clarity and speed.</h2>
            <p className="hero-text">Create, organize, and monitor every product in one elegant workspace built for modern teams.</p>
          </div>
          <div className="hero-metrics">
            ...
            <div className="metric-card">
              ...
              <span className="metric-label">Control at a glance</span>
            </div>
          </div>
        </div>

        <div className="stats">
          <div className="chip">Total: <strong>{products.length}</strong></div>
